...
<body>
								...
								<ul id="nav" class="nav navbar-nav">
									...
									<li><a href="javascript:void(0)">INDUSTRIES</a>
										<ul class="dropdown">
											...
											<li><a href="manufacturing">Manufacturing &
													Retailers</a></li>
				...
				<div class="about-content">
					...
					<div class="col-md-6  col-sm-6 col-xs-12">
						<div class="single-about">
							<p class="bolt"></p>
							<p>Innovit USA is a fast growing, global IT Consulting
								Services company providing Solutions with cutting edge
								Technologies. Innovit USA specializes in Java, IT Management,
								Big Data, Cloud, and Mobility. We guarantee cost savings,
								quality and outcomes giving our clients the space to focus on
								driving their business forward. We thrive by building highly
								effective business relationships with our clients. We
								continuously evolve to meet our clients' long term needs and
								address their unique requirements. .</p>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="image">
							<img src="img/about.jpg" alt="#"> <a
								href="https://youtu.be/z1JG_iGp9zs"
								...
								<div class="skill-content">
									...
									<p>
										<b>InnovIT USA Inc. is the fastest growing IT
											...
											Langhorne, PA. InnovIT management has been in IT Industry for
											over 18 years. InnovIT main goal is to provide high quality
											and cost effective IT solutions and services to our clients..</b>
									</p>
	...
	<section id="newslatter" class="newslatter section">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="news-text wow fadeIn" data-wow-duration="0.8s"
						data-wow-delay="0.5s">
						<h4>don't miss out</h4>
						<h2>sign up for updates</h2>
						<p>Get all latest news and our exclusive content straight to
							your email inbox</p>
					</div>
					<div class="form wow shake" data-wow-duration="0.8s"
						data-wow-delay="0.5s">
