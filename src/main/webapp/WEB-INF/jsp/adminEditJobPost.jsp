			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="forms-main">
						<h2 class="inner-tittle">Edit Job Details</h2>
						<div class="graph-form">
							<div class="form-body">
								<form action="update_jobPost" method="post">
									<div class="form-group">
									 
										<label for="exampleInputEmail1">Job Title*</label> <input
											type="text" value="${res.jobTitle}" name="jobTitle"
											class="form-control" id="exampleInputEmail1"
											placeholder="Job Title">
									</div>
									<input type="hidden" value="${res.jobId }" name="jobId"/>
									<div class="form-group">
										<label for="exampleInputPassword1">Location(Optional)</label>
										<input type="text" value="${res.location}" name="location"
											class="form-control" id="exampleInputEmail1"
											placeholder="Location">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Job Type*</label> <input
											type="text" name="jobType" value="${res.jobType}"
											class="form-control" id="exampleInputEmail1"
...
<p>Add Job Description</p>
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Email*</label> <input
											type="email" name="email" value="${res.email}"
											class="form-control" id="exampleInputEmail1"
											placeholder="Email">
									</div>
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Company Name*</label> <input
											type="text" name="companyName" value="${res.companyName}"
											class="form-control" id="exampleInputEmail1"
											placeholder="Company Name">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Website (optional)</label> <input
											type="text" name="website" value="${res.website}"
											class="form-control" id="exampleInputEmail1"
											placeholder="Website">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Tagline (optional)</label> <input
											type="text" name="companyTagLine"
											value="${res.companyTagLine}" class="form-control"
											id="exampleInputEmail1" placeholder="Tagline">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Video (optional)</label> <input
											type="text" name="videoLink" value="${res.videoLink}"
											class="form-control" id="exampleInputEmail1"
											placeholder="Video">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Twitter Username
											(optional)</label> <input type="text" name="twitterUserName"
											class="form-control" value="${res.twitterUserName}"
											id="exampleInputEmail1" placeholder="Twitter Username">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Logo*</label> <input
											type="text" name="companyLogo" value="${res.companyLogo}"
											class="form-control" id="exampleInputEmail1"
											placeholder="Company Logo URI">
									</div>
									<button type="submit" class="btn btn-default">Edit Job
										Details</button>
								</form>
							</div>
